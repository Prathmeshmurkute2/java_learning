...
//		str1.forEach(System.out::println); // forEch is a terminal operation
...
//		System.out.println(numbers.stream().distinct().count()); //count is terminal operation
	...
	//	System.out.println(numbers.stream().filter(n -> n > 5).count()); // filter is intermediate opertaion
		
//		numbers.stream().distinct().sorted().forEach(System.out::println); // sorted is intermediate method
		
//		System.out.println(numbers.stream().reduce(0, (n , m) ->n +m)); // reduce is terminal operatio
		//System.out.println(numbers.stream().reduce(0, Integer::sum));
	//	System.out.println(numbers.stream().reduce(0, FirstStreamDemo::add));
		
	//	numbers.stream().limit(5).forEach(System.out::println); // limit is intermediate operation
